...
describe("Prompt 5 protected downloads", () => {
  ...
  it("uses private bucket paths, never local release/public paths", () => {
    expect(deliverables.epub.path).toBe("books/curls-and-contemplation/epub/Curls-and-Contemplation-v8-20260610.epub");
    expect(deliverables.pdf.path).toBe("books/curls-and-contemplation/pdf/CurlsAndContemplation-POD-Royal-v8-20260610.pdf");
