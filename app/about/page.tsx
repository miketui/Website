...
export default function Page() {
  return (
    <main>
      ...
      <CaptureBand source="about" heading="Read the way he writes." copy="One welcome note, then the occasional letter on pricing, craft, and the business nobody taught you. Start with the free Detailed Pricing Guide. No spam." />
    </main>
  );
}
