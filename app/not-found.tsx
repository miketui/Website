 ...
 * visitor back into the funnel (pricing kit, quiz, book) and offer the
  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-5 py-20 text-center md:px-6 md:py-28">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-whitegold/85">
        The link you followed doesn&rsquo;t exist (or moved). Start with the free Pricing Confidence Kit, or find your blind spot in two minutes.
      </p>
      <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
        <MagneticCurlButton href="/pricing-kit">Get the Free Pricing Kit</MagneticCurlButton>
