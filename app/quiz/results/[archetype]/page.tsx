      ...
      <Section eyebrow="Start tonight" title="The fix begins with one worksheet and one chapter.">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div className="editorial-panel rounded-[2rem] p-6 md:p-8">
            ...
            <p className="mt-3 text-sm leading-6 text-whitegold/70">One exercise from {result.bookPart}, designed to be finished in an evening. Take the quiz and it lands in your inbox with your full diagnosis.</p>
            <h3 className="mt-8 font-display text-2xl text-white">The chapter that fixes it</h3>
            <p className="mt-3 text-sm leading-6 text-whitegold/70">Preview the matching chapter now &mdash; it&rsquo;s already public.</p>
          ...
          <div className="editorial-panel rounded-[2rem] p-6 md:p-8">
            ...
            <p className="mt-3 leading-8 text-whitegold/80">The book walks all four blind spots in sequence &mdash; start with {result.bookPart}, then keep going. {launch.priceCopy}; {launch.deliveryCopy.toLowerCase()}.</p>
            <div className="mt-6">
